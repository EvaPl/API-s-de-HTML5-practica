if (window.File && window.FileReader && window.FileList && window.Blob) {
    function handleFileSelect(evt) {
        ...
        reader.onload = (function (theFile){
            return function (e) {
                let videoDiv = document.getElementsByClassName('video_container');
                ...
                document.getElementById('video_output').insertBefore(div, null);
                ...
                document.getElementById('video_output').insertBefore(loadingMessage, null);
                ...
                document.getElementById('video_output').removeChild(loadingMessage);
